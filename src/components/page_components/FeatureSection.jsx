        ...
        <div className="flex h-full flex-col items-center justify-center md:flex-col lg:flex-row">
          <div className="col-span-1 flex flex-col items-center gap-6 px-10 py-10 lg:px-4 xl:px-2 bg-white rounded-lg hover:scale-110 transition-all ease-in-out duration-500 hover:shadow-lg m-4 ">
            ...
            <div className="flex flex-col gap-2 px-2 text-center">
              ...
              <p className="text-base font-medium text-gray-500 leading-7 lg:px-8">
                Customized questions based on your job role and experience
                level.
              </p>
            </div>
          </div>
          <div className="col-span-1 flex flex-col items-center gap-6 px-10 py-10 lg:px-4 xl:px-2 bg-white rounded-lg hover:scale-110 transition-all ease-in-out duration-500 hover:shadow-lg m-4 ">
            ...
            <div className="flex flex-col gap-2 px-2 text-center">
              ...
              <p className="text-base font-medium text-gray-500 leading-7 lg:px-8">
                Comprehensive reports highlighting your strengths and areas for
                improvement.
              </p>
            </div>
          </div>
          <div className="col-span-1 flex flex-col items-center gap-6 px-10 py-10 lg:px-4 xl:px-2 bg-white rounded-lg hover:scale-110 transition-all ease-in-out duration-500 hover:shadow-lg m-4 ">
            ...
            <div className="flex flex-col gap-2 px-2 text-center">
              ...
              <p className="text-base font-medium text-gray-500 leading-7 lg:px-8">
                Tailored practice sessions for specific roles and industries.
              </p>
            </div>
          </div>
        </div>
